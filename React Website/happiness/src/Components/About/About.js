...
function About(){
    ...
    <div>
        <div className="about">
            ...
            <div className="text leftcontent">
            ...
            <div className="text rightcontent">
            ...
            <div className="text leftcontent">
                <h3>Health</h3>
                <p>Healthy Life Expectancy is the average number of years that a newborn can expect to live in “full health” 
